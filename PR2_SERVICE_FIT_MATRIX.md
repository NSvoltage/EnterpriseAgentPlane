...
### 3. AgentCore Is Best Treated as Control Plane + Light/Medium Execution
Use it for:
- task orchestration
- isolated sessions
- async workflows
...
### 4. MCP Should Be Hidden Behind Enterprise Tool Gateway
...
**Source:** EnterpriseAgentPlane design pack  
**Status:** Reference for scope decisions  
